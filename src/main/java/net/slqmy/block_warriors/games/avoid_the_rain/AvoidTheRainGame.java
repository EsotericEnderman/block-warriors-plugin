package net.slqmy.block_warriors.games.avoid_the_rain;
...
import net.slqmy.block_warriors.utility.MathsUtility;
import org.bukkit.*;
...
public final class AvoidTheRainGame extends AbstractGame {
	...
	public AvoidTheRainGame(@NotNull BlockWarriors plugin, @NotNull Arena arena) {
		super(plugin, arena);
