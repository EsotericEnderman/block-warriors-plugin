...
public abstract class AbstractGame implements Listener {
	...
	public AbstractGame(@NotNull final BlockWarriors plugin, @NotNull final Arena arena, final KitType @NotNull [] kits) {
		this.arena = arena;
	...
	public AbstractGame(@NotNull final BlockWarriors plugin, @NotNull final Arena arena) {
