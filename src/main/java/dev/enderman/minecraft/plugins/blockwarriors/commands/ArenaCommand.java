package dev.enderman.minecraft.plugins.blockwarriors.commands;
...
import dev.enderman.minecraft.plugins.blockwarriors.guis.KitSelectionGUI;
import dev.enderman.minecraft.plugins.blockwarriors.guis.TeamSelectionGUI;
import dev.enderman.minecraft.plugins.blockwarriors.managers.ArenaManager;
import dev.enderman.minecraft.plugins.blockwarriors.types.AbstractCommand;
...
public final class ArenaCommand extends AbstractCommand {
	...
	public ArenaCommand(@NotNull final BlockWarriorsPlugin plugin) {
		super(
						"arena",
